          ...
          <form action="{{route('admin.main.update')}}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="row">
                <div class="form-group col-md-3 mt-3">
                    ...
                    <img style="height: 25vh" src="{{(@$main->bc_img)?url($main->bc_img):asset("asset/img/bc_img.jpg")}}" alt="img-thumbnail">
                ...
                <div class="form-group col-md-4 mt-3">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control" id="sub_title" name="sub_title" value="{{(@$main->sub_title)?$main->sub_title:"Sub title"}}">
                    </div>
                    <div class="form-group col-md-3 mt-3">
                        <h3>Nav Logo</h3>
                        {{--<img style="height: 25vh" src="{{url($main->nav_logo)}}" alt="img-thumbnail">--}}
                        <input class="mt-2" type="file" id="nav_logo" name="nav_logo">
                    </div>
                    <div>
                       <h4>Upload Resume</h4>
