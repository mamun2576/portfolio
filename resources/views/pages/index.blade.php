...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Mamun Portfolio</a>
        ...
        <!-- Masthead-->
        <header class="masthead" style="background-image: url(<?php echo (@$main->bc_img)?url($main->bc_img):asset("asset/img/bc_img.jpg") ?>)">
            <div class="container">
                <div class="masthead-subheading">{{(@$main->sub_title)?$main->sub_title:"Sub title"}}</div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright ©Mamun Website 2021</div>
